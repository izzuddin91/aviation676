          ...
          <div className="mt-10">
            ...
            <fieldset className="mt-4">
              ...
              <div className="grid grid-cols-4 gap-4 sm:grid-cols-8 lg:grid-cols-4">
                ...
                {/* <!-- Active: "ring-2 ring-indigo-500" --> */}
                <label className="border-indigo-500 group relative flex items-center justify-center rounded-md border py-3 px-4 text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6 cursor-pointer bg-white text-gray-900 shadow-sm">
