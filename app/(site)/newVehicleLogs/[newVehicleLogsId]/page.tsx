...
const formSchema = yup
  .object({
    ...
    partsName: yup.string().required("please key in parts name"),
    description: yup.string().required("please key in description"),
    price: yup.number().required("need to add total"),
    lifeSpan: yup.number().default(0),
  })
  .required();
